...
func LoggerSetup() {
	...
	errCreateDir := os.MkdirAll("/opt/wgManagerAuth/logs", 0755) //create log directory if does not exist
	...
	file, errLog := os.OpenFile("/opt/wgManagerAuth/logs/"+timeStr+" log.txt", os.O_CREATE|os.O_APPEND|os.O_WRONLY, 0755) //open file
	if errLog != nil {
